...
const initializePassword = r => require.ensure([], () => r(require('../page/forget/initializePassword')), 'initializePassword')
...
const selectServiceArea = r => require.ensure([], () => r(require('../page/express/commonComponents/SelectAddressInput')), 'selectServiceArea')
const expressList = r => require.ensure([], () => r(require('../components/common/expressList')), 'expressList')
const searchExpress = r => require.ensure([], () => r(require('../page/search/searchExpress')), 'searchExpress')
const addExpress = r => require.ensure([], () => r(require('../page/express/addExpress')), 'addExpress')
const addExpressByStaff = r => require.ensure([], () => r(require('../page/express/addExpressByStaff')), 'addExpressByStaff')
const selfExpressDelivery = r => require.ensure([], () => r(require('../page/express/selfExpressDelivery')), 'selfExpressDelivery')
const pickupQRCode = r => require.ensure([], () => r(require('../components/common/pickupQR/pickupQRCode')), 'pickupQRCode')
const deliveryExpress = r => require.ensure([], () => r(require('../page/express/deliveryExpress')), 'deliveryExpress')
const recordSendExpress = r => require.ensure([], () => r(require('../page/express/recordSendExpress')), 'recordSendExpress')
const sendExpressInventory = r => require.ensure([], () => r(require('../page/express/sendExpressInventory')), 'sendExpressInventory')

export default [{
  path: '/',
  component: App, //顶层路由，对应index.html
  children: [ //二级路由。对应App.vue
    //地址为空时跳转home页面 设置登录首页
    {
      path: '',
    ...
    {
      path: '/addExpressByStaff',
      component: addExpressByStaff,
      meta: {keepAlive: true},
    },
    {
      path: '/deliveryExpress',
      component: deliveryExpress,
    },
    {
      path: '/selfExpressDelivery',
      component: selfExpressDelivery,
      meta: {keepAlive: true},
    },
    {
      path: '/recordSendExpress',
      component: recordSendExpress,
    },
    {
      path: '/sendExpressInventory',
      component: sendExpressInventory,
    },
    {
      path: '/pickupQRCode',
