        ...
        <section class="profile-info">
            <section class="headportrait">
                ...
                <div class="headportrait-div">
                    <!--<img  v-if="userInfo" :src="staticImgUrl + userInfo.avatar" class="headportrait-div-top">-->
                    <img v-if="userInfo" src="../../../images/icons/users-icon.png" class="headportrait-div-top">
            ...
            <!--<mu-raised-button label="退出登录" fullWidth @click="exitlogin" class="demo-raised-button"/>-->
        </section>
...
//    import {getStore} from '../../config/mUtils';
    ...
    export default {
        ...
        methods: {
            ...mapMutations([
                'OUT_LOGIN','OUT_CUSTOMER_INFO', 'SAVE_AVANDER','RECORD_CUSTOMER_INFO'
            ]),
            exitlogin(){
                this.show=true;
                this.isEnter=true;
            ...
            //退出登录
            async outLogin(){
                this.OUT_CUSTOMER_INFO();
//                this.waitingThing();
//                this.$router.go(-1);
              await removeStore('phoneNumber');
              await this.routerProfile();
              console.info('getStore:'+JSON.stringify(getStore('phoneNumber')))
//                await signout();
            },
          async routerProfile(){
